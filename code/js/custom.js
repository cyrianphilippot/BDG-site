    ...
    function () {
      $(".knob").each(function () {
        ...
        element.knob({
          ...
          bgColor: " #f7f7f7 ",
          fgColor: " #00cfef ",
          thickness: 0.2, // Thickness of Skill Knobs
          dynamicDraw: true,
          draw: function () {
            $(this.i).val(this.cv);
          },
  ...
  $(function () {
    ...
    $("#contact-form").validate({
      ...
      submitHandler: function (form) {
        ...
        $("#output").html(
          '<i class="icon-send fa fa-spinner fa-spin"></i> Email is sending...</p>'
        );
        $.ajax({
          type: "POST",
          url: "php/mail.php",
          ...
          success: function (data) {
            if (data == "ok") {
              ...
              $("#output").html(
                "<p>Thank you for contact us. As early as possible we will contact you</p>"
              );
            } else {
